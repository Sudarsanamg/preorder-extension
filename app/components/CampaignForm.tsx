...
interface CampaignFormProps {
  ...
  handleCampaignDataChange: <K extends keyof CampaignFields>(field: K, value: any) => void;
                    ...
                    <div>
                      ...
                      <BlockStack gap={"300"}>
                        ...
                        {campaignData.paymentMode === "full" && (
                          <>
                            <TextField
                              ...
                              onChange={(e) => handleCampaignDataChange("fullPaymentText", e)}
                        ...
                        <RadioButton
                          ...
                          onChange={() => handleCampaignDataChange("paymentMode", "partial")}
                        />
                          ...
                          <div>
                            <div style={{ display: "flex", gap: 10 }}>
                              <div>
                                <ButtonGroup variant="segmented">
                                  <Button
                                    pressed={campaignData.partialPaymentType === "percent"}
                                    onClick={() =>
                                      handleCampaignDataChange(
                                        "partialPaymentType",
                                        "percent"
                              ...
                              <div style={{ flex: 1 }}>
                                <TextField
                                  ...
                                  onChange={(val) => {
                                    if (isNaN(Number(val))) return;
                                    handleCampaignDataChange("partialPaymentPercentage", val);
                                  }}
                                  error={
                              ...
                              <div>
                                <ButtonGroup variant="segmented">
                                  <Button
                                    ...
                                    onClick={() => handleCampaignDataChange("duePaymentType", 1)}
                                    icon={ClockIcon}
                                  ></Button>
                                  <Button
                                    pressed={campaignData.duePaymentType === 2}
                                    onClick={() => handleCampaignDataChange("duePaymentType", 2)}
                              ...
                              <div style={{}}>
                                {campaignData.duePaymentType === 1 && (
                                  <TextField
                                    ...
                                    onChange={(e) => handleCampaignDataChange("paymentAfterDays", e)}
                            ...
                            <TextField
                              ...
                              onChange={(value)=>handleCampaignDataChange("partialPaymentText", value)}
                            ...
                            <div style={{ marginTop: 10 }}>
                              <BlockStack gap="200">
                                <TextField
                                  ...
                                  onChange={(value) => handleCampaignDataChange("partialPaymentInfoText", value)}
                                />
                                <Text as="p" variant="bodyMd">
                    ...
                    >
                      ...
                      <div>
                        <TextField
                          ...
                          onChange={(value) => handleCampaignDataChange("campaignEndTime", value)}
                        />
                      </div>
                    </div>
                    <Text as="p" variant="bodyMd">
                  ...
                  <Card>
                    ...
                    <BlockStack gap={"100"}>
                      <RadioButton
                        ...
                        id="unfulfilled"
                        name="unfulfilled"
                        onChange={() => handleCampaignDataChange("fulfilmentMode", "UNFULFILED")}
                      />
                      <RadioButton
                        label="Scheduled"
                        ...
                        id="Scheduled"
                        name="Scheduled"
                        onChange={() => handleCampaignDataChange("fulfilmentMode", "SCHEDULED")}
                      />
                              ...
                              <ButtonGroup variant="segmented">
                                <Button
                                  ...
                                  onClick={() =>
                                    ...
                                    handleCampaignDataChange("scheduledFullfillmentType", 1)
                                  }
                                  icon={ClockIcon}
                                ></Button>
                                <Button
                                  ...
                                  onClick={() =>
                                    ...
                                    handleCampaignDataChange("scheduledFullfillmentType", 2)
                                  }
                                  icon={CalendarCheckIcon}
                                ></Button>
                              </ButtonGroup>
                              <div style={{}}>
                                {campaignData.scheduledFullfillmentType === 1 && (
                                  <TextField
                                    ...
                                    onChange={(value) => handleCampaignDataChange("scheduledDays", value)}
                                  />
                                )}
                      ...
                      <RadioButton
                        ...
                        id="onhold"
                        name="onhold"
                        onChange={() => handleCampaignDataChange("fulfilmentMode", "ONHOLD")}
                      />
                    </BlockStack>
                  </Card>
                </div>
